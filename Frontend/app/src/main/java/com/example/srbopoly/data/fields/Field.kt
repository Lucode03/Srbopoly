                ...
                onUnmortgage: () -> Unit = {})
{
    ...
    when (field) {
        ...
        is PropertyField -> PropertyFieldAction(
            field, action, onResult, fullWidthModifier, isMyTurn, playerID, isTurnActionsPhase,
            myMoney, onBuildHouse, onSellHouse, onMortgage, onUnmortgage
        )
